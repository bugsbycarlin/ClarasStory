...
--   self.spelling_object = display.newSprite(self.performanceAssetGroup, self.sprite[picture], {frames=self.picture_info[picture].frames})
...
--   self.spelling_object.info = self.picture_info[picture]
...
--       local button_backing = display.newSprite(self.performanceAssetGroup, self.sprite["Letter_Box"], {frames=self.picture_info["Letter_Box"].frames})
...
--       button_backing.info = self.picture_info["Letter_Box"]
...
--       local button_letter = display.newSprite(self.performanceAssetGroup, self.sprite[picture], {frames=self.picture_info[picture].frames})
...
--       button_letter.info = self.picture_info[picture]
--       button_letter.intro = "static"
--       button_letter:setFrame(self.picture_info[picture]["sprite_count"])
