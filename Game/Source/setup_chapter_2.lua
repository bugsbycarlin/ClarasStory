...
function setup_chapter_2:setup(chapter_structure)
  ...
  flow.chapter_2_part_1.next = "chapter_2_part_2"
  flow.chapter_2_part_1.prev = nil
  flow.chapter_2_part_2.next = "chapter_2_part_3"
  flow.chapter_2_part_2.prev = "chapter_2_part_1"
  flow.chapter_2_part_3.next = "chapter_2_part_4"
  flow.chapter_2_part_3.prev = "chapter_2_part_2"
  flow.chapter_2_part_4.next = "chapter_2_part_5"
  flow.chapter_2_part_4.prev = "chapter_2_part_3"
  flow.chapter_2_part_5.next = "chapter_2_mandala"
  flow.chapter_2_part_5.prev = "chapter_2_part_4"
  flow.chapter_2_mandala.next = nil
  flow.chapter_2_mandala.prev = "chapter_2_part_5"



  flow.chapter_2_part_1.cleanup=true
  flow.chapter_2_part_2.cleanup=true
  flow.chapter_2_part_3.cleanup=true
  flow.chapter_2_part_4.cleanup=true
  flow.chapter_2_part_5.cleanup=true



  flow.chapter_2_part_1.additional_actions = {
    {
      start_time= 0,
  ...
  for i = 0, 24 do
    ...
    table.insert(flow.chapter_2_part_1.additional_actions, right_scoot_action)
    left_scoot_action = {
    ...
    table.insert(flow.chapter_2_part_1.additional_actions, left_scoot_action)
  end
  ...
  for i = 1,8 do
    ...
    table.insert(flow.chapter_2_part_1.additional_actions, staccato_honk_action)
  end
  ...
  for i = 1, 8 do
    ...
    table.insert(flow.chapter_2_part_2.additional_actions, more_honks)
  end
  ...
  for i = 8, 24 do
    ...
    table.insert(flow.chapter_2_part_2.additional_actions, right_scoot_action)
    left_scoot_action = {
      start_time= 1500 * i + 750 * 3/4,
      label="scoot left",
      action=function(part)
    ...
    table.insert(flow.chapter_2_part_2.additional_actions, left_scoot_action)
  end

  flow.chapter_2_part_3.additional_actions = {
    {
      start_time= 0,
  ...
  flow.chapter_2_part_4.additional_actions = {
    {
      start_time=0,
  ...
  flow.chapter_2_part_5.additional_actions = {
    {
      start_time=6900,
